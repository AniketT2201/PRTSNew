...
export const MaterialUser: React.FC<IPrtsProps> = (props: IPrtsProps) => {
    ...
    async function GetMaterialControllerData() {
        setLoading(true);
    ...
    const update = async () => {
        try {
            ...
            const result = await spCrudObj.insertData('MaterialControllers', fields, props);
            console.log("Insert result:", result);

            await GetMaterialControllerData();
    ...
    const DeleteUser = async (item) => {
        try {
            ...
            const result = await spCrudObj.deleteData('MaterialControllers', item, props);
            console.log("Delete result:", result);

            alert("Data deleted successfully.");
            await GetMaterialControllerData(); // Optional: refresh list after delete
        } catch (error) {
            ...
            <div className="header">
                <div className="left-banner">
                    <div className="logo-text">
                        <h2>Configure Material Controller</h2>
                    </div>
                </div>
            </div>
